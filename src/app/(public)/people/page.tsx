...
export default function Home() {
  return (
    ...
    {/* Hero Section */}
    <div className="relative bg-gradient-to-r from-emerald-800 to-teal-600">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <div className="mt-10 flex items-center gap-x-6">
              <Link 
                href="/app/people" 
                className="rounded-md bg-white px-6 py-3 text-base font-semibold text-emerald-700 shadow-sm hover:bg-emerald-50"
              >
                Get Started
              </Link>
              <Link 
                href="#features" 
                className="text-base font-semibold leading-6 text-white hover:text-emerald-100"
              >
            ...
            <div className="relative bg-white/10 rounded-xl shadow-xl p-6 backdrop-blur-sm">
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <div className="h-12 bg-emerald-900/20 rounded flex items-center px-4">
                    <div className="h-6 w-6 rounded-full bg-white/40 mr-3"></div>
                    <div className="h-4 w-32 bg-white/40 rounded"></div>
                  </div>
                </div>
                
                <div className="space-y-3 p-4 bg-emerald-900/10 rounded">
    ...
    <div id="features" className="py-24 bg-white">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-emerald-600">HR Management</h2>
          ...
          <div className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
            {[
              ...
              <div key={idx} className="relative pl-16">
                <div className="absolute left-0 top-0 flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-600">
      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="flex flex-col items-center text-center">
            <div className="h-16 w-16 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-800 mb-4">
          ...
          <div className="relative">
            <div className="p-8 bg-emerald-50 rounded-lg">
              <div className="absolute -top-4 -left-4 w-20 h-20 bg-white rounded-lg shadow-lg flex items-center justify-center">
                <div className="text-emerald-800 font-bold text-xl">HR</div>
              </div>
              ...
              <div className="h-64 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-24 h-24 text-emerald-700">
    ...
    <div className="bg-emerald-700">
      <div className="container mx-auto px-6 py-16 lg:px-8 text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <Link
            href="#"
            className="text-base font-semibold leading-6 text-white hover:text-emerald-200"
          >
