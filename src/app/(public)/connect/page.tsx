  ...
  return (
    <div className="bg-white">
      ...
      <div className="py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-teal-600">Powerful API</h2>
      ...
      <div id="api-docs" className="bg-gray-50 py-24">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center mb-16">
            <h2 className="text-base font-semibold leading-7 text-teal-600">Documentation</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5">
              <div className="md:col-span-1 bg-gray-100 p-6 border-r border-gray-200">
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-teal-600 hover:text-teal-800 cursor-pointer">/documents</div>
                  <div className="text-sm text-teal-600 hover:text-teal-800 cursor-pointer">/validation</div>
                  <div className="text-sm text-teal-600 hover:text-teal-800 cursor-pointer">/templates</div>
                  <div className="text-sm text-teal-600 hover:text-teal-800 cursor-pointer">/status</div>
                </div>
              </div>
      ...
      <div className="bg-white py-24">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center mb-16">
            <h2 className="text-base font-semibold leading-7 text-teal-600">Seamless Integration</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
