      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Oriana Booking makes it easy to manage appointments for any type of service or individual. Perfect for salons, clinics, freelancers, and more.
          </p>
        </div>
            ...
            {[
              {
                ...
                description: "Allow clients to book appointments online 24/7, reducing phone calls and administrative work.",
                icon: "🌐"
              },
              {
                title: "Automated Reminders",
                description: "Reduce no-shows with automated email and SMS reminders to clients before appointments.",
                icon: "🔔"
              },
              {
                title: "Resource Management",
                description: "Manage staff schedules, room availability, and equipment allocation efficiently.",
                icon: "📋"
              },
              {
                title: "Calendar Integration",
                description: "Sync with Google Calendar, Outlook, and other popular calendar applications.",
                icon: "📅"
              },
            ].map((feature, idx) => (
          ...
          {[
            {
              ...
              description: "Clients select the service they need from your customizable catalog.",
              icon: (
            ...
            },
            {
              step: "2",
              title: "Select Time",
              description: "Available time slots are displayed based on your schedule and preferences.",
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
            ...
            },
            {
              ...
              description: "Client provides their information or logs in to their existing account.",
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
            ...
            },
            {
              step: "4",
              title: "Confirmation",
              description: "Booking is confirmed with automatic notifications to both parties.",
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <div className="bg-amber-100 rounded-lg p-8 relative">
              ...
              <div className="bg-blue-100 rounded-lg p-4 mt-12">
                <div className="text-sm font-medium text-blue-800 mb-2">Oriana Market</div>
                <div className="space-y-2">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Automatically generate invoices from appointments and manage your finances in one place.
            </p>
            <ul className="mt-8 space-y-4">
              <li className="flex items-start">
                ...
                <p className="ml-3 text-base text-gray-600">
                  Convert completed appointments to invoices with a single click
                </p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0">
    ...
    <div className="bg-amber-50 py-24">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center mb-16">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Oriana Booking adapts to the unique needs of different business types.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              title: "Healthcare",
              description: "Manage patient appointments, medical consultations, and treatment schedules.",
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
            ...
            },
            {
              ...
              description: "Schedule salon, spa, and wellness services with staff assignment.",
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
            ...
            {
              title: "Freelancers",
              description: "Perfect for consultants, tutors, and independent professionals.",
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
