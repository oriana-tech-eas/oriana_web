...
const ConnectLayout = ({ children }: LayoutProps) => {
  ...
  const menuItems = [
    ...
    { href: `${BOOKING_BASE_URL}/clients`, icon: UsersIcon, text: 'Claves' },
    { href: `${BOOKING_BASE_URL}/appointments`, icon: CalendarDaysIcon, text: 'Historial' },
    { href: `${BOOKING_BASE_URL}/services`, icon: Cog8ToothIcon, text: 'Servicios' }
  ]

  const logoPath = isDark 
  ? "/brand/white/oriana-connect.svg"
  : "/brand/oriana-connect.svg"
