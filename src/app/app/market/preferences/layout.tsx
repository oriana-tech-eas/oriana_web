  ...
  return (
    <Container>
      ...
      <nav className="flex gap-2 my-10">
        <CustomLink active={pathname.includes('categories')} href="/app/market/preferences/categories">Categorias</CustomLink>
        <CustomLink active={pathname.includes('taxes')} href="/app/market/preferences/taxes">Impuestos</CustomLink>
        <CustomLink active={pathname.includes('documents')} href="/app/market/preferences/documents">Documentos</CustomLink>
        <CustomLink active={pathname.includes('users')} href="/app/market/preferences/users">Usuarios</CustomLink>
      </nav>
      {children}
    </Container>
  );
