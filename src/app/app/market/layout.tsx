...
export default function MarketLayout({ children, modal }: LayoutProps) {
  ...
  const menuItems = [
    ...
    {
      href: `${MARKET_BASE_URL}/sales`,
      icon: ArrowUpCircleIcon,
      text: "Ingresos",
    },
    {
      href: `${MARKET_BASE_URL}/expenses`,
      icon: ArrowDownCircleIcon,
      text: "Gastos",
    },
    {
      href: `${MARKET_BASE_URL}/quotes`,
      icon: DocumentChartBarIcon,
      text: "Cotizaciones",
    },
    {
      href: `${MARKET_BASE_URL}/contacts`,
      icon: UserGroupIcon,
      text: "Contactos",
    },
    { href: `${MARKET_BASE_URL}/products`, icon: CubeIcon, text: "Productos" },
    {
      href: `${MARKET_BASE_URL}/reports`,
      icon: ChartBarIcon,
      text: "Reportes",
    },
    {
      href: `${MARKET_BASE_URL}/preferences/categories`,
      icon: Cog8ToothIcon,
      text: "Preferencias",
    },
  ];
